...
//        List<EntryTestRecord> records = loadAllRecords();
...
//                writer.println(r.getApplicantId() + "," +
//                        r.getTestDateTime() + "," +
//                        r.isAttempted() + "," +
//                        r.getScore());
//            }
...
//        for (EntryTestRecord r : loadAllRecords()) {
//            if (r.getApplicantId().equals(applicantId)) {
//                return r;
//            }
//        }
//        return null;
...
//                    list.add(record);
//                } catch (Exception ex) {
//                    System.err.println("Skipped corrupted record: " + line);
//                }
//            }
//        } catch (IOException e) {
//            e.printStackTrace();
